...
git clone https://github.com/16GBRAM/android_device_xiaomi_munch.git -b 15-qpr2 device/xiaomi/munch; \

git clone https://github.com/16GBRAM/android_vendor_xiaomi_munch.git -b 15-qpr2 vendor/xiaomi/munch; \
